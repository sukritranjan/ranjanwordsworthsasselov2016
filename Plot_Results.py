...
if plot_dust_clouds:
	...
	ax[1].set_ylabel(r'Integrated Intensity (photons s$^{-1}$cm$^{-2}$ nm$^{-1}$)')
	...
	plt.savefig('./Plots/results_dust_clouds.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_dust_pco2:
	...
	plt.tight_layout(rect=(0,0,1,0.94))
	plt.savefig('./Plots/results_dust_pco2.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_ph2s_clouds:
	...
	plt.subplots_adjust(wspace=0., hspace=0.2)
	plt.savefig('./Plots/results_ph2s_clouds.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_pso2_clouds:
	...
	plt.tight_layout(rect=(0,0,1,0.94))
	plt.subplots_adjust(wspace=0., hspace=0.2)
	plt.savefig('./Plots/results_pso2_clouds.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_ph2s_pco2:
	...
	plt.savefig('./Plots/results_ph2s_pco2.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_pso2_pco2:
	...
	ax[0].legend(bbox_to_anchor=[0, 1.13, 1., .152], loc=3, ncol=3, mode='expand', borderaxespad=0., fontsize=10)
	plt.tight_layout(rect=(0,0,1,0.94))
	plt.savefig('./Plots/results_pso2_pco2.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_clouds:
	...
	ax[0].set_ylabel(r'Integrated Intensity (photons s$^{-1}$cm$^{-2}$ nm$^{-1}$)')
	...
	plt.tight_layout()
	plt.savefig('./Plots/results_clouds.eps', orientation='portrait',papertype='letter', format='eps')
...
#########################
	...
	#plt.tight_layout()
	#plt.savefig('./Plots/results_td.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_td_dep_lowpressure:
	...
	for P_ind in range(0, numP):
		...
		ax.set_yscale('log')
		ax.set_ylabel(r'Integrated Intensity (photons s$^{-1}$cm$^{-2}$ nm$^{-1}$)')
	...
	plt.tight_layout()
	plt.savefig('./Plots/results_td_lowpressure.eps', orientation='portrait',papertype='letter', format='eps')
...
if plot_tpdep:
	...
	ax[0].legend(loc=0, fontsize=12)
	plt.tight_layout()
	plt.savefig('./Plots/results_tpdep.eps', orientation='portrait',papertype='letter', format='eps')
